...
<head>
    ...
    <title>Exportar mercancia | ERP manager</title>
    ...
    <link rel="stylesheet" href="./css/remision-salida.css"/>
...
<body>
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="main-content" id="main-content">
                        ...
                        <?php
                        include "vistas/inventario/exportar-mercancia.php";
                        ?>
    ...
    <script src="./js/inventario/exportar-mercancia.js"></script>
    <script src="./js/inventario/tabla-presalida.js"></script>
    <script src="./js/inventario/procesar-remision-salida.js"></script>
    <script src="./js/reportes/logo.js"></script>
    <script src="./js/reportes/fuente.js"></script>
    <script src="./js/reportes/remision-salida.js"></script>
