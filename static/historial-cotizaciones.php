...
<head>
    ...
    <title>Reportes de cotizaciones | ERP manager</title>
...
<body>
                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="row mb-2">
                        <div class="col-12 col-md-10">
                            <h1 class="h3 mb-3">Cotizaciones</h1>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Historial de cotizaciones realizadas</h1>
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                            ...
                            <div class="col-3">
                                <?php include_once('vistas/general/contextual-menu-coti.php'); ?>
    ...
    <!-- Mis scripts -->
    <script src="js/historial/lista-cotizaciones.js"></script>
