function setPaginador(numProductos, cantPorPagina, id, indicador_pag, arreglo_prod, pag_actual){
    ...
    <ul class="pagination justify-content-center">
      <li class="page-item disabled" onclick='goPage(${pag_actual-1}, ${JSON.stringify(arreglo_prod)})'>
        <a class="page-link" href="#" tabindex="-1" aria-disabled="true">Anterior</a>
      </li>
      <div id="paginator-body" class="pagination-body">
        
      </div>
      <li class="page-item" onclick='goPage(${pag_actual+1}, ${JSON.stringify(arreglo_prod)})'>
