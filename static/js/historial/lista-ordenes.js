$(document).ready(function () {
  ...
  let sucursal_id = $("#user-data").attr("id_sucursal")
    tabla = $('#example').DataTable({
        ...
        serverSide: true,
        ajax:{
            url: '../servidor/historial/tabla-ventas.php?sucursal_id='+ sucursal_id,//
        ...
        columns:  [
            ...
            { data:2, title:'Fecha' },
            { data:3, title:'Hora' },
            { data:4, title:'Subtotal' },
            { data:5, title:'Utilidad' },
            { data:6, title:'Impuesto' },
            { data:7, title:'Total' },
            { data:8, title:'Metodo pago' },
            { data:9, title:'Estatus' },
            { data:10, title:'Vendedor' },
