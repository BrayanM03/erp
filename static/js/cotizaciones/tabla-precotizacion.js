$(document).ready(function () {
    ...
    tabla = $('#example').DataTable({
        ...
        serverSide: true,
        ajax:{
            url: '../servidor/cotizaciones/cotizacion-server_processing.php',
            dataType: 'json'
        },
        responsive: true,
        order: [0, 'desc'],
        ...
        columns:  [ 
            ...
            { data:null, title:'Precio unit', render:(row)=>{
            ...
            { data:null, title:'Descuento', render:(row)=>{
              let descuento_sf = row[6]
              let desc = Intl.NumberFormat('es-MX',{style:'currency',currency:'MXN'}).format(descuento_sf)
              return desc;
            } },

            { data:null, title:'Total', render:(row)=>{
              let total_sf = row[7]
              let total = Intl.NumberFormat('es-MX',{style:'currency',currency:'MXN'}).format(total_sf)
              return total;
            }},
