...
<head>
    ...
    <title>Reportes de salida de mercancia | ERP manager</title>
...
<body>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Historial de remision de mercancia salida</h1>
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                            ...
                            <div class="col-3">
                                <?php include_once('vistas/general/contextual-menu-salidas.php'); ?>
    ...
    <!-- Mis scripts -->
    <script src="js/historial/lista-salidas.js"></script>
